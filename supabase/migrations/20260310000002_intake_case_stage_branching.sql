...
-- ============================================
--
-- When a user completes an intake step (small_claims_intake or pi_intake)
-- and has selected a case_stage other than 'start', the trigger bulk-skips
-- the tasks they've already completed and unlocks the correct next task.
--
-- Changes from previous migration (20260308000003_already_filed_branching):
--
--   1. pi_intake completion: conditional branching based on case_stage
--      - start/medical -> unlock pi_medical_records
--      - insurance     -> skip medical+evidence, unlock pi_insurance_communication
--      - demand        -> skip medical+evidence+insurance, unlock prepare_pi_demand_letter
--      - negotiation   -> skip through demand, unlock pi_settlement_negotiation
--      - filing        -> skip through negotiation, unlock prepare_pi_petition
--
--   2. small_claims_intake completion: conditional branching based on case_stage
--      - start         -> unlock evidence_vault
--      - demand_sent   -> skip evidence+demand, unlock prepare_small_claims_filing
--      - filed         -> skip through filing prep, unlock file_with_court
--      - served        -> skip through serve_defendant, unlock prepare_for_hearing
--      - hearing       -> skip through prepare_for_hearing, unlock hearing_day
--
