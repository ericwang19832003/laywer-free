-- ============================================
-- Already-Filed Branching (PI Settlement)
-- ============================================
--
-- Extends the pi_settlement_negotiation branching from 2 paths to 3:
--
--   Path A: settled OR not filing suit
--     -> skip all 11 litigation tasks, unlock pi_post_resolution directly
--     (unchanged from previous migration)
--
--   Path B: filing suit + already filed petition
--     -> skip prepare_pi_petition + pi_file_with_court
--     -> unlock pi_serve_defendant directly
--     (NEW)
--
--   Path C: filing suit + not yet filed petition
