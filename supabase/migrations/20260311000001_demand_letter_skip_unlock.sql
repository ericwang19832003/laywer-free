-- ============================================
-- Demand Letter Skip → Unlock Next Task
-- ============================================
--
-- When a user skips a demand letter task (because they've already filed
-- a petition), the trigger should unlock the next task in the chain,
-- just as it would on completion.
--
-- Affected task keys:
--   - prepare_pi_demand_letter  → unlock pi_settlement_negotiation
--   - prepare_demand_letter     → unlock prepare_small_claims_filing
--   - prepare_lt_demand_letter  → unlock prepare_landlord_tenant_filing
-- ============================================
