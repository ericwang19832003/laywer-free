...
-- ============================================
--
-- Inserts 7 new mid-litigation tasks between pi_serve_defendant
-- and pi_trial_prep:
...
--
-- Three changes:
--   1. seed_case_tasks()  — add 7 new PI task inserts
--   2. unlock_next_task() — replace single transition with 8
--   3. Backfill existing PI cases with the 7 new tasks
-- ============================================


-- ============================================
-- 1) seed_case_tasks() — add 7 mid-litigation PI tasks
-- ============================================
...
-- ============================================
-- 2) unlock_next_task() — expand PI chain
-- ============================================
-- Replaces the single pi_serve_defendant -> pi_trial_prep
-- transition with 8 transitions through the new mid-litigation tasks.
-- All other chains (debt, landlord-tenant, small claims, family, civil)
-- are unchanged.
-- ============================================
...
BEGIN
  ...
  -- PI: pi_serve_defendant -> pi_wait_for_answer (NEW)
  ...
  -- PI: pi_wait_for_answer -> pi_review_answer (NEW)
  ...
  -- PI: pi_review_answer -> pi_discovery_prep (NEW)
  ...
  -- PI: pi_discovery_prep -> pi_discovery_responses (NEW)
  ...
  -- PI: pi_discovery_responses -> pi_scheduling_conference (NEW)
  ...
  -- PI: pi_scheduling_conference -> pi_pretrial_motions (NEW)
  ...
  -- PI: pi_pretrial_motions -> pi_mediation (NEW)
  ...
  -- PI: pi_mediation -> pi_trial_prep (NEW)
...
-- ============================================
-- 3) Backfill existing PI cases with new tasks
-- ============================================
