...
-- ============================================
--
-- Makes the pi_wait_for_answer → pi_review_answer transition
-- conditional: it does NOT fire when the user reports
-- case_removed = 'yes' in the guided answers metadata.
--
