-- =============================================================
-- CONTRACT, PROPERTY, OTHER — Detail Tables & Workflow Triggers
-- =============================================================
-- Adds fully specialized workflows for contract, property, and
-- other dispute types. Creates detail tables with RLS, updates
-- seed_case_tasks() and unlock_next_task() with new branches.
-- =============================================================
...
-- =============================================================
-- UPDATE unlock_next_task() — Add 3 new unlock chains
-- =============================================================
...
BEGIN
  ...
  -- Property: property_negotiation -> property_prepare_filing (complete OR skip)
  ...
  -- Property: property_prepare_filing -> property_file_with_court
  ...
  -- Property: property_file_with_court -> property_serve_defendant
  ...
  -- Property: property_serve_defendant -> property_wait_for_answer
  ...
  -- Property: property_wait_for_answer -> property_review_answer
  ...
  -- Property: property_review_answer -> property_discovery
  ...
  -- Property: property_discovery -> property_post_resolution
  ...
  -- Other: other_prepare_filing -> other_file_with_court
  ...
  -- Other: other_file_with_court -> other_serve_defendant
  ...
  -- Other: other_serve_defendant -> other_wait_for_answer
  ...
  -- Other: other_wait_for_answer -> other_review_answer
  ...
  -- Other: other_review_answer -> other_discovery
  ...
  -- Other: other_discovery -> other_post_resolution
  ...
  -- PI: evidence_vault -> preservation_letter
  IF NEW.task_key = 'evidence_vault' AND NEW.status = 'completed' AND OLD.status != 'completed' THEN
    UPDATE public.tasks SET status = 'todo', unlocked_at = now()
    WHERE case_id = NEW.case_id AND task_key = 'preservation_letter' AND status = 'locked';
  END IF;

  -- PI: preservation_letter -> pi_insurance_communication (on complete OR skip)
  ...
  -- PI: pi_settlement_negotiation SKIPPED -> unlock prepare_pi_petition
