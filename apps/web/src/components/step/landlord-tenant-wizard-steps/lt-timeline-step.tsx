...
export function LtTimelineStep({ events, onEventsChange }: LtTimelineStepProps) {
    ...
    <div className="space-y-6">
      <div>
        ...
        <HelpTooltip label="What events should I include?">
          <p>
            Include dates like when the lease was signed, when you moved in, when issues
            started, when you requested repairs or sent notices, and when you decided to
            file. Judges appreciate a clear, organized timeline.
          </p>
        </HelpTooltip>
      </div>
