...
export const piCourtSelectionConfig: GuidedStepConfig = {
  ...
  generateSummary(answers) {
    ...
    // Recommended court based on answers
    ...
    if (damages === 'unsure') {
      items.push({
        status: 'needed',
        text: 'Damages estimate is unclear — calculate medical bills + lost wages + pain & suffering to finalize court selection.',
      })
    }
