  ...
  return {
    ...
    questions: [
      ...
      },
      {
        ...
        acknowledgeLabel: "I'll prepare my rebuttals",
      },
    ],
    ...
    generateSummary(answers) {
      ...
      if (answers.likely_defense) {
        const labels: Record<string, string> = {
          sol: `Likely defense: Statute of Limitations — verify breach date is within ${solText}.`,
...
export const contractDefensesGuideConfig = createContractDefensesGuideConfig()
