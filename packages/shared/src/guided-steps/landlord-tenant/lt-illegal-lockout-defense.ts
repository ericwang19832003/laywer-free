...
export const ltIllegalLockoutDefenseConfig: GuidedStepConfig = {
  ...
  questions: [
    ...
    },
    {
      ...
      acknowledgeLabel: 'I understand my rights \u2014 this is illegal',
    ...
    },
    {
      ...
      acknowledgeLabel: "I'll document the threat immediately",
    ...
    },
    {
      ...
      acknowledgeLabel: 'I understand \u2014 only courts can evict me',
    },
    {
      id: 'what_to_do',
      type: 'info',
      ...
      acknowledgeLabel: "I'm taking these steps now",
    },
    {
      id: 'called_police',
      type: 'yes_no',
    ...
    },
    {
      ...
      acknowledgeLabel: "I'll call the police now",
