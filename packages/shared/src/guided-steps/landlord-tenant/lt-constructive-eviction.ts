  ...
  questions: [
    {
      ...
      acknowledgeLabel: 'I understand what constructive eviction means and when it applies',
    },
    {
      id: 'four_elements',
      type: 'info',
      ...
      acknowledgeLabel: 'I understand the four legal elements I must prove for constructive eviction',
    },
    {
      id: 'conditions',
      type: 'single_choice',
    ...
    },
    {
      ...
      acknowledgeLabel: "I understand — I'll send written notice via certified mail before claiming constructive eviction",
    ...
    },
    {
      ...
      acknowledgeLabel: "I understand — I'll document everything and send a written termination notice before vacating",
    ...
    },
    {
      ...
      acknowledgeLabel: "I understand — I will not leave without proper notice and documentation to avoid abandonment liability",
    },
  ],
