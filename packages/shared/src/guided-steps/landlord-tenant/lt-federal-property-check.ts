...
export const ltFederalPropertyCheckConfig: GuidedStepConfig = {
  ...
  questions: [
    ...
    },
    {
      ...
      type: 'info',
      prompt:
        'HOW TO CHECK:\n\n• Ask your landlord or property manager directly\n• Check your lease for mentions of HUD, FHA, Section 8, LIHTC, or federal programs\n• Search the National Housing Preservation Database (preservationdatabase.org)\n• Check if your mortgage is backed by Fannie Mae (knowyouroptions.com/loanlookup) or Freddie Mac (loanlookup.freddiemac.com)\n• Contact your local HUD office: 1-800-569-4287',
  ...
  generateSummary(answers) {
    ...
    if (isFederallyBacked(answers)) {
      ...
      items.push({
        status: 'needed',
        text: 'Federal backing status unknown. Research whether the property participates in federal housing programs — if it does, stronger protections (including 30-day notice) may apply.',
      })
