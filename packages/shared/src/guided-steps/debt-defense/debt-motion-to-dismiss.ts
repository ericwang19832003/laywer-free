  ...
  questions: [
    {
      ...
      type: 'info',
      acknowledgeLabel: 'Got it — let\'s see my grounds →',
      prompt:
    ...
    },
    {
      id: 'sol_expired_info',
      type: 'info',
      acknowledgeLabel: 'Got the SOL argument →',
      prompt:
    ...
    },
    {
      ...
      type: 'info',
      acknowledgeLabel: 'Got the standing argument →',
      prompt:
    ...
    },
    {
      ...
      type: 'info',
      acknowledgeLabel: 'Got the venue argument →',
      prompt:
    ...
    },
    {
      ...
      type: 'info',
      acknowledgeLabel: 'Got the claim argument →',
      prompt:
    ...
    },
    {
      id: 'timing',
      type: 'info',
      acknowledgeLabel: 'Understood the timing →',
      prompt:
