...
export const debtValidationResponseGuideConfig: GuidedStepConfig = {
  ...
  questions: [
    ...
    },
    {
      id: 'no_response_info',
      type: 'info',
      acknowledgeLabel: 'Got it — strong defense noted →',
      prompt:
    ...
    },
    {
      ...
      type: 'info',
      acknowledgeLabel: 'Got it — I\'ll challenge the gaps →',
      prompt:
    ...
    },
    {
      ...
      type: 'info',
      acknowledgeLabel: 'Got it — I\'ll review carefully →',
      prompt:
    ...
    },
    {
      ...
      type: 'info',
      acknowledgeLabel: 'Documenting the violation →',
      prompt:
