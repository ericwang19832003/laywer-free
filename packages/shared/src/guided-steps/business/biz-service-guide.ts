...
export const bizServiceGuideConfig: GuidedStepConfig = {
  ...
  questions: [
    ...
    },
    {
      id: 'llc_info',
      type: 'info',
      acknowledgeLabel: 'Got it — find the agent →',
      prompt:
    ...
    },
    {
      ...
      type: 'info',
      acknowledgeLabel: 'Got it — serve the owner →',
      prompt:
    ...
    },
    {
      ...
      type: 'info',
      acknowledgeLabel: 'I\'ll look them up →',
      prompt:
    ...
    },
    {
      id: 'long_arm_info',
      type: 'info',
      acknowledgeLabel: 'Understood — use long-arm service →',
      prompt:
    ...
    },
    {
      ...
      type: 'info',
      acknowledgeLabel: 'Got it — I\'ll try alternatives →',
      prompt:
