...
export const bizCourtroomGuideConfig: GuidedStepConfig = {
  ...
  questions: [
    ...
    },
    {
      ...
      acknowledgeLabel: 'Got it, I\'ll use this as a guide →',
    ...
    },
    {
      ...
      options: [
        { value: 'three_copies', label: '3 copies of every document (you, judge, opposing party)' },
        { value: 'petition_docs', label: 'Original petition and any amended petitions' },
        { value: 'contracts', label: 'All contracts or agreements at issue' },
        { value: 'payment_records', label: 'Invoices, receipts, and payment records' },
        { value: 'communications', label: 'Emails and texts (printed, organized by date)' },
        { value: 'timeline', label: 'Written timeline of events' },
        { value: 'photos', label: 'Photos if relevant' },
        { value: 'business_authority', label: 'Business registration documents proving authority to represent' },
      ],
  ...
  generateSummary(answers) {
    ...
    if (bringAnswer && bringAnswer !== 'none') {
      ...
      items.push({ status: 'needed', text: 'Prepare court materials: 3 copies of all documents, contracts, payment records, communications, and timeline.' })
    }
