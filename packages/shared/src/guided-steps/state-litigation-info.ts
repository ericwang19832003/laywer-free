...
export const STATE_LIT_INFO: Record<string, StateLitigationInfo> = {
  ...
  CA: {
    smallClaims: {
      ...
      eFilingUrl: 'selfhelp.courts.ca.gov/self-help/small-claims',
      eFilingName: 'California Courts Self-Help (find your county portal)',
    ...
    contract: {
      ...
      eFilingUrl: 'selfhelp.courts.ca.gov',
      eFilingName: 'California Courts Self-Help (find your county portal)',
      helpSiteUrl: 'selfhelp.courts.ca.gov',
      helpSiteName: 'California Courts Self-Help',
      feeWaiverForm: 'Request to Waive Court Fees (Form FW-001)',
    ...
    landlordTenant: {
      ...
      noticeDefaultDays: '3 days (pay or quit / perform or quit); 30 days to terminate tenancy < 1 year; 60 days ≥ 1 year',
    },
  },
