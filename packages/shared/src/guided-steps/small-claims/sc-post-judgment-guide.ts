  ...
  return {
    ...
    questions: [
...

      {
        id: 'collection_tools',
        type: 'info',
        prompt: `IF THEY DON'T PAY — YOUR COLLECTION TOOLS:\n\n1. Abstract of Judgment — File with the county clerk to create a lien on their property. They can't sell or refinance without paying you first.\n\n2. Writ of Execution — Ask the court to issue a writ. A constable can seize the debtor's non-exempt assets (bank accounts, vehicles, etc.).\n\n3. Bank Account Garnishment — If you know their bank, you can garnish funds directly from their account.${sc.wageGarnishmentAllowed ? '\n\n4. Wage Garnishment — You may be able to garnish wages directly from their employer. Rules vary by state.' : '\n\nNOTE: Your state may limit or prohibit wage garnishment for civil judgments. Focus on asset seizure, bank garnishment, and property liens instead.'}\n\n${sc.wageGarnishmentAllowed ? '5' : '4'}. Post-Judgment Interest — Your judgment accrues interest at ${sc.judgmentInterestRate} (${sc.judgmentInterestCitation}) until paid.\n\n${sc.wageGarnishmentAllowed ? '6' : '5'}. Judgment Debtor Examination — Force them to appear in court and disclose their assets, income, and bank accounts under oath.`,
        showIf: (answers) =>
...

      {
        id: 'debtor_exam_info',
        type: 'info',
        prompt: "TIP: If you don't know what assets they have, start with a Judgment Debtor Examination. The court orders them to appear and disclose everything — bank accounts, employer, property, vehicles. Then you'll know exactly what to garnish or levy.",
        showIf: (answers) =>
          answers.outcome === 'won' &&
