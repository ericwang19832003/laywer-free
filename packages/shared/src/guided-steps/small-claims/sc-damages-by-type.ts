  ...
  return {
    ...
    questions: [
      ...
      },
      {
        ...
        acknowledgeLabel: "I'll gather these documents for my claim",
      ...
      },
      {
        ...
        acknowledgeLabel: "I understand my damages formula",
      ...
      {
        id: 'property_damage_repair_vs_replace',
        type: 'info',
        prompt: `REPAIR OR REPLACEMENT COST (pick one — mutually exclusive):\n• Repairable → get 2–3 written estimates; the judge uses a reasonable estimate\n• Totaled/destroyed → fair market value just before the incident\n\nYou can only claim one. If repairable, use repair cost. If destroyed, use market value.`,
        acknowledgeLabel: 'I understand repair vs. replacement cost →',
        showIf: (answers) => answers.claim_type === 'property_damage',
      },
      {
        id: 'property_damage_diminished_value',
        type: 'info',
        prompt: `DIMINISHED VALUE (repaired property only):\nEven after repair, property may be worth less than before — for example, a repaired car with an accident on its record. You can claim the difference in value with a written appraisal.\n\nNote: This only applies if you claimed repair cost, not replacement value.`,
        acknowledgeLabel: 'I understand diminished value →',
        showIf: (answers) => answers.claim_type === 'property_damage',
      },
      {
        id: 'property_damage_loss_of_use',
        type: 'info',
        prompt: `LOSS OF USE:\nIf you had to rent a substitute while your property was out of service, you can recover those costs. Keep all rental or substitute-service receipts.\n\nAll amounts combined — repair/replacement + diminished value + loss of use — must be under ${sc.limit}.`,
        acknowledgeLabel: 'I understand loss of use →',
        showIf: (answers) => answers.claim_type === 'property_damage',
      },
      {
        ...
        acknowledgeLabel: "I'll gather police report, estimates, and receipts",
      ...
      },
      {
        ...
        acknowledgeLabel: "I'll get written estimates for repairs",
      ...
      },
      {
        ...
        acknowledgeLabel: "I'll write out my itemized damages",
      ...
      },
      {
        ...
        acknowledgeLabel: "I'll gather supporting documentation for each amount",
      ...
      },
      {
        ...
        acknowledgeLabel: "I understand my options",
